...
ActiveRecord::Schema.define(version: 20160905182922) do
  ...
  add_index "chat_subscriptions", ["dm_chat_id"], name: "index_chat_subscriptions_on_dm_chat_id", using: :btree
  add_index "chat_subscriptions", ["user_id"], name: "index_chat_subscriptions_on_user_id", using: :btree
